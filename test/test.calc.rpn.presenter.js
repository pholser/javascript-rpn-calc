var PresenterTest = TestCase('test.calc.rpn.presenter');

PresenterTest.prototype.testEnter = function() {
...
PresenterTest.prototype.testExecute = function() {
    var model = JsMockito.mock(calc.rpn.model.Calculator);
...
PresenterTest.prototype.testWhenNumberTyped = function() {
...
PresenterTest.prototype.testWhenDecimalTyped = function() {
...
PresenterTest.prototype.testWhenDecimalTypedWithDecimalAlreadyInEntry = function() {
    /*:DOC += <div id="calculator"><input id="entry" name="entry" type="text" value="34." /></div> */
    var view = new calc.rpn.view.View();
...
PresenterTest.prototype.testWhenOperandEntered = function() {
